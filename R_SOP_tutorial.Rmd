...
# Dataframe columns can be indexed using $ following the format dataframe$columnName.
...
# The dplyr library is a powerful library that allows users to easily manipulate matrices and dataframes.
...
# values into a column, and converting to a dataframe
...
# Creates a dataframe with an equal number of rows as the pcb data frame with 
# 1 column
